...
module.exports = function(options, issue) {
  ...
  return function(req, res, next) {
    ...
    function issued(err, accessToken, refreshToken, params) {
      ...
      if (!accessToken) { return next(new TokenError('Invalid authorization cross domain code', 'invalid_grant')); }
      ...
      // The draft specification does not provide guidance on whether or not a
      // refresh token should be issued.  However, per discussion on the mailing
      // list, the author of the specification sees no reason to exclude this
      // possibility.
      //
      // http://lists.openid.net/pipermail/openid-specs-native-apps/Week-of-Mon-20150615/000281.html
      // http://lists.openid.net/pipermail/openid-specs-native-apps/Week-of-Mon-20150615/000282.html
